...
if (
    ...
    $phone = mysqli_real_escape_string($db_connection, trim($data->user_phone));
    $insertUser = mysqli_query($db_connection, "INSERT INTO `employee`(`EmpName`,`JobTitle`,`Phone`) VALUES('$username','$useremail','$phone')");
    if ($insertUser) {
